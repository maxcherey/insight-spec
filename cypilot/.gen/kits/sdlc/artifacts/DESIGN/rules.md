...
**Dependencies**:
- `{cypilot_path}/.gen/kits/sdlc/artifacts/DESIGN/template.md` — structural reference
- `{cypilot_path}/.gen/kits/sdlc/artifacts/DESIGN/checklist.md` — semantic quality criteria
- `{cypilot_path}/.gen/kits/sdlc/artifacts/DESIGN/examples/example.md` — reference implementation
